        ...
        <form role="form" action="/countries/<?php echo htmlspecialchars( $country["country_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="country_name" name="country_name" value="<?php echo htmlspecialchars( $country["country_name"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" maxlength="100" required>
            </div>
            <div class="row">
              <div class="col-xs-4 col-md-2">
                <div class="form-group">
                  <label for="region_id">Region</label>
                  <input type="text" class="form-control" id="region_id" name="region_id" value="<?php echo htmlspecialchars( $country["region_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" onchange="search(this.value, 'regions');" required>
                </div>
              </div>
