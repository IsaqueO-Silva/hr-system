        ...
        <form role="form" action="/regions/<?php echo htmlspecialchars( $region["region_id"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post">
          <div class="box-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="region_name" name="region_name" value="<?php echo htmlspecialchars( $region["region_name"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" maxlength="100" required>
            </div>
          </div>
          <!-- /.box-body -->
